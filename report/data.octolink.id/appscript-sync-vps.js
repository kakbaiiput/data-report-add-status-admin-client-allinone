...
var VPS_SYNC_URL  = 'https://report.octolink.id/api/sync.php';
var SYNC_SECRET   = 'dataclientstarlink';            // harus sama dengan di db.php
...
function onOpen() {
  // Fungsi ini akan digabung dengan onOpen() yang sudah ada di appscript utama.
  // Cukup panggil addSyncMenu() dari onOpen() yang sudah ada.
}
